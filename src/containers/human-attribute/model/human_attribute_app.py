...
ort_session_1 = onnxruntime.InferenceSession(model_path + '/model_1.onnx', providers=['CPUExecutionProvider'])
ort_session_2 = onnxruntime.InferenceSession(model_path + '/model_2.onnx', providers=['CPUExecutionProvider'])
ort_session_3 = onnxruntime.InferenceSession(model_path + '/model_3.onnx', providers=['CPUExecutionProvider'])
ort_session_4 = onnxruntime.InferenceSession(model_path + '/model_4.onnx', providers=['CPUExecutionProvider'])
outputs_template = {
