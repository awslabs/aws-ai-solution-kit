...
export class CarLicensePlateSageMakerFeatureNestedStack extends FeatureNestedStack {
  constructor(scope: Construct, id: string, props: FeatureNestedStackProps) {
    ...
    this.templateOptions.description = '(SO8023-clg) - AI Solution Kit - Car License Plate. Template version v1.4.0. See https://awslabs.github.io/aws-ai-solution-kit/en/deploy-car-license-plate.';
