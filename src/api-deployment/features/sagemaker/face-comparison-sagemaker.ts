...
export class FaceComparisonSageMakerFeatureNestedStack extends FeatureNestedStack {
  constructor(scope: Construct, id: string, props: FeatureNestedStackProps) {

    super(scope, id, props);
    const featureName = 'face-comparison';
    this.templateOptions.description = '(SO8023-face-comparison-sagemaker) - AI Solution Kit - Face Comparison. Template version v1.2.0. See https://awslabs.github.io/aws-ai-solution-kit/en/deploy-face-comparison.';
    ...
    if (props.ecrDeployment != null) {
      const ecrCR = new CustomResource(this, `${featureName}-ecr`, {
        ...
        properties: {
          SrcImage: 'docker://public.ecr.aws/aws-gcr-solutions/aws-gcr-ai-solution-kit/face-comparison-sagemaker:latest',
