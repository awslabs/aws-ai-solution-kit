...
export class FaceComparisonSageMakerFeatureNestedStack extends FeatureNestedStack {
  constructor(scope: Construct, id: string, props: FeatureNestedStackProps) {
    ...
    this.templateOptions.description = '(SO8023-fcg) - AI Solution Kit - Face Comparison. Template version v1.4.0. See https://awslabs.github.io/aws-ai-solution-kit/en/deploy-face-comparison.';
