...
export class PornographyDetectionSageMakerFeatureNestedStack extends FeatureNestedStack {
  constructor(scope: Construct, id: string, props: FeatureNestedStackProps) {
    ...
    this.templateOptions.description = '(SO8023-pornography-detection-sagemaker) - AI Solution Kit - Pornography Detection. Template version v1.3.0. See https://awslabs.github.io/aws-ai-solution-kit/en/deploy-pornography-detection.';
