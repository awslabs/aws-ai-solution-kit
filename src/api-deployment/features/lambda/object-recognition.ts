...
export class ObjectRecognitionFeatureNestedStack extends FeatureNestedStack {
  constructor(scope: Construct, id: string, props: FeatureNestedStackProps) {
    ...
    this.templateOptions.description = '(SO8023-object-recognition) - AI Solution Kit - Object Recognition. Template version v1.4.0. See https://awslabs.github.io/aws-ai-solution-kit/en/deploy-object-recognition.';
