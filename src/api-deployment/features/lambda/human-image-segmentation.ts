...
export class HumanImageSegmentationFeatureNestedStack extends FeatureNestedStack {
  constructor(scope: Construct, id: string, props: FeatureNestedStackProps) {
    ...
    this.templateOptions.description = '(SO8023-seg) - AI Solution Kit - Human Image Segmentation. Template version v1.2.0. See https://awslabs.github.io/aws-ai-solution-kit/en/deploy-human-segmentation.';
