...
export class GreenScreenMattingSMFeatureNestedStack extends FeatureNestedStack {
  constructor(scope: Construct, id: string, props: FeatureNestedStackProps) {
    ...
    this.templateOptions.description = '(SO8023-seg) - AI Solution Kit - Green Screen Matting. Template version v1.2.0. Template version v1.2.0. See https://awslabs.github.io/aws-ai-solution-kit/en/deploy-human-segmentation.';
    ...
    if (props.ecrDeployment != null) {
      ...
      const ecrCR = new CustomResource(this, `${featureName}Ecr`, {
        ...
        properties: {
          SrcImage: 'docker://public.ecr.aws/aws-gcr-solutions/aws-gcr-ai-solution-kit/green-screen-matting:latest',
