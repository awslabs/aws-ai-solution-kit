...
export class ApiExplorerNestedStack extends NestedStack {
  ...
  constructor(scope: Construct, id: string, props: ApiExplorerProps) {
    ...
    this.templateOptions.description = '(SO8023-api-explorer) - AI Solution Kit - API Explorer. Template version v1.2.0. See https://aws-samples.github.io/aws-ai-solution-kit/en/api-explorer.';
