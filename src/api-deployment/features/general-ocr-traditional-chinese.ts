...
export class GeneralOCRTraditionalChineseFeatureNestedStack extends FeatureNestedStack {
  constructor(scope: Construct, id: string, props: FeatureNestedStackProps) {
    ...
    this.templateOptions.description = '(SO8023-ocr-traditional) - AI Solution Kit - General OCR Traditional Chinese. Template version v1.2.0. See https://aws-samples.github.io/aws-ai-solution-kit/en/deploy-general-ocr-traditional.';
