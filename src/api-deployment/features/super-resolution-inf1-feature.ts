...
export class SuperResolutionInf1FeatureNestedStack extends FeatureNestedStack {
  constructor(scope: Construct, id: string, props: FeatureNestedStackProps) {
    ...
    this.templateOptions.description = '(SO8023-sr) - AI Solution Kit - Super Resolution with Amazon SageMaker Inferentia Instance. Template version v1.2.0. See https://awslabs.github.io/aws-ai-solution-kit/en/deploy-super-resolution-inf1.';
