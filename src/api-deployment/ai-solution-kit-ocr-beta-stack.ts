...
import { GeneralOCRAdvancedBetaSageMakerFeatureNestedStack } from './features/sagemaker/general-ocr-advanced-beta-sagemaker';
...
export class AISolutionKitOcrBetaStack extends Stack {
  constructor(scope: Construct, id: string, props: AISolutionKitStackProps) {
    ...
    {
      const generalOCRSageMaker = new GeneralOCRAdvancedBetaSageMakerFeatureNestedStack(this, 'General-OCR-Advanced-SageMaker', {
        restApi: api,
        customAuthorizationType: authType,
        ecrDeployment: ecrDeployment,
        updateCustomResourceProvider: updateCustomResourceProvider,
      ...
      this.addOutput(cfnTemplate, api.restApiId, 'general-ocr-advanced-ml', 'General OCR Advanced SageMaker', 'ConditionGeneralOCRSageMaker');
    }
