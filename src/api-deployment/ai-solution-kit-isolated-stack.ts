...
import { CustomOCRIsolatedFeatureNestedStack } from './features/custom-ocr-isolated';
...
export class AISolutionKitIsolatedStack extends Stack {
  constructor(scope: Construct, id: string, props: AISolutionKitStackProps) {
    ...
    // Feature: Custom OCR
    {
      const customOCRFeatureNestedStack = new CustomOCRIsolatedFeatureNestedStack(this, 'Custom-OCR', {
        restApi: api,
        customAuthorizationType: authType,
        ecrDeployment: ecrDeployment,
        updateCustomResourceProvider: updateCustomResourceProvider,
