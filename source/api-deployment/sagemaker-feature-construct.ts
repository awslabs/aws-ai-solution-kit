import { AuthorizationType, AwsIntegration, Deployment, RestApi } from '@aws-cdk/aws-apigateway';
import { Effect, ManagedPolicy, PolicyDocument, PolicyStatement, Role, ServicePrincipal } from "@aws-cdk/aws-iam";
import { CfnEndpoint, CfnEndpointConfig, CfnModel } from "@aws-cdk/aws-sagemaker";
import { Aws, CfnCondition, CfnOutput, Construct, CustomResource, Fn, RemovalPolicy } from "@aws-cdk/core";
