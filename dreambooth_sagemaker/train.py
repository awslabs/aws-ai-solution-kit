...
def start_sagemaker_training(model_dir, use_txt2img, instance_type="ml.g5.16xlarge"):
    ...
    role = "arn:aws:iam::648149843064:role/service-role/AmazonSageMaker-ExecutionRole-20230419T140494"
    # image_uri = "683638520402.dkr.ecr.us-west-2.amazonaws.com/aigc-webui-sagemaker:latest"
    image_uri = "648149843064.dkr.ecr.us-east-1.amazonaws.com/dreambooth-training-repo"
