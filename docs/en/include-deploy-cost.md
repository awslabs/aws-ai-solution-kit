...
In AWS China (Ningxia) Region operated by NWCD (cn-northwest-1), process an image of 1MB in 4 seconds
...
|AWS Lambda | 4096MB memory, 4 seconds run each time      | ¥1815.6  |
...
| AWS Lambda                     | 4096MB memory, 4 seconds run each time     | $266.8  |
