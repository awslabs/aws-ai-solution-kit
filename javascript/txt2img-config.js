...
function scrap_ui_component_value(config) {
    ...
    config["script_list"] = document.querySelector("#script_list > label > div > div.wrap-inner.svelte-1g4zxts" > span).textContent
    document.querySelector("#script_list > label > div > div.wrap-inner.svelte-a6vu2r > span")
